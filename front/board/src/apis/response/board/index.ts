...
import LikeResponseDto from './Like.reponse.dto';
...
export type { DeleteBoardResponseDto, 
  GetBoardResponseDto, GetListResponseDto, GetMyListResponseDto, GetSearchListResponseDto,
  GetTop3ListResponseDto, GetTop15RelatedSearchWordResponseDto, GetTop15SearchWordResponseDto,
  LikeResponseDto, PatchBoardResponseDto, PostBoardResponseDto, PostCommentResponseDto
};